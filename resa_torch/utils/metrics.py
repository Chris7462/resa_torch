...
class Metrics:
    """
    Tracks and computes running metrics for training.
    ...
    def update(
        ...
        Args:
            ...
            seg_pred: Segmentation logits (B, C, H, W)
            exist_pred: Existence logits (B, num_lanes)
            seg_gt: Segmentation ground truth (B, H, W)
            exist_gt: Existence ground truth (B, num_lanes)
        """
        # Accumulate losses
